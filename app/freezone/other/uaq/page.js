        ...
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 32px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
            ...
            <div style={{ background: '#fff', border: '1.5px solid #e0e0e0', borderRadius: 10, padding: '22px 28px' }}>
              ...
              <div style={{ color: '#444', fontSize: 15, fontFamily: 'Montserrat, Arial, sans-serif' }}>The cost depends on the type of license and facilities you choose. Basic packages for small businesses or freelancers can start from around AED 8,000, making it one of the most cost-effective options in the UAE.</div>
            </div>
            {/* FAQ 5 */}
            <div style={{ background: '#fff', border: '1.5px solid #e0e0e0', borderRadius: 10, padding: '22px 28px' }}>
