        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 32px' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 48, alignItems: 'center', justifyContent: 'center' }}>
            ...
            <div style={{ flex: '1 1 340px', minWidth: 260, maxWidth: 420, display: 'flex', justifyContent: 'center' }}>
              <img src="/images/service1.png" alt="RAK City" style={{ width: '100%', maxWidth: 380, height: 220, objectFit: 'cover', borderRadius: 18, boxShadow: '0 2px 12px rgba(30,198,182,0.07)' }} />
            </div>
          </div>
        </div>
      </section>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 32px' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 24, justifyContent: 'center', marginBottom: 32 }}>
            ...
            <div style={{ background: '#fff', borderRadius: 10, padding: '22px 24px', minWidth: 220, maxWidth: 320, flex: '1 1 220px', boxShadow: '0 2px 8px rgba(30,198,182,0.04)', textAlign: 'center', fontFamily: 'Montserrat, Arial, sans-serif', fontWeight: 500 }}>
              ...
              <div style={{ color: '#444', fontWeight: 400, fontSize: 15, marginTop: 8 }}>Extension of existing company operations in RAKEZ</div>
            </div>
            {/* Card 2 */}
            <div style={{ background: '#fff', borderRadius: 10, padding: '22px 24px', minWidth: 220, maxWidth: 320, flex: '1 1 220px', boxShadow: '0 2px 8px rgba(30,198,182,0.04)', textAlign: 'center', fontFamily: 'Montserrat, Arial, sans-serif', fontWeight: 500 }}>
              Free Zone Establishment (FZE)
              <div style={{ color: '#444', fontWeight: 400, fontSize: 15, marginTop: 8 }}>Single shareholder company with minimum capital AED 100,000</div>
            </div>
            {/* Card 3 */}
            <div style={{ background: '#fff', borderRadius: 10, padding: '22px 24px', minWidth: 220, maxWidth: 320, flex: '1 1 220px', boxShadow: '0 2px 8px rgba(30,198,182,0.04)', textAlign: 'center', fontFamily: 'Montserrat, Arial, sans-serif', fontWeight: 500 }}>
              Free Zone LLC (FZ-LLC)
              <div style={{ color: '#444', fontWeight: 400, fontSize: 15, marginTop: 8 }}>2-5 shareholders with minimum capital AED 100,000</div>
            </div>
          </div>
          {/* Key Benefits Box */}
