  ...
  return (
    <>
      ...
      <FreezoneHeroWithForm
        title={"Business Setup in\nMeydan Free Zone"}
        description={"Establish your business in the heart of Dubai's most prestigious free zone, designed by His Highness Sheikh Mohammed bin Rashid Al Maktoum with world-class infrastructure and strategic location."}
      ...
      <section style={{ background: '#f2f8fc', padding: '56px 0 64px 0', borderTop: '1px solid #e6ecf1' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 16px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'flex-start', gap: 36, flexWrap: 'wrap' }}>
            {/* Left List */}
            ...
            {/* Center Image */}
            <div style={{ minWidth: 400, maxWidth: 600, flex: '1 1 600px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
              <img src="/images/meydan-2.avif" alt="Meydan Free Zone Cityscape" style={{ width: '100%', maxWidth: 560, borderRadius: 16, boxShadow: '0 4px 24px rgba(30,198,182,0.10)', objectFit: 'cover', aspectRatio: '1.3/1' }} />
            </div>
            {/* Right List */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: 18, minWidth: 180 }}>
