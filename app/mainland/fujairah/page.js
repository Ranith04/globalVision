...
export default function FujairahMainlandPage() {
  return (
    <>
      <Navbar />
        ...
        <div style={{
         ...
         <div style={{
           ...
           <div style={{ color: '#fff', textAlign: 'left', maxWidth: 900 }}>
            ...
            Fujairah Mainland<br />Company Formation
            </h1>
            <p style={{ fontFamily: 'Montserrat, Arial, sans-serif', fontSize: '1.1rem', color: '#ffffff', marginBottom: 0, fontWeight: 400, lineHeight: 1.7, opacity: 0.95 }}>
            Fujairah Mainland is an emerging and strategically located business zone in the UAE, regulated by the Fujairah Department of Economic Development (FDDED). It offers direct access to the Indian Ocean, making it a vital hub for trade, shipping, and logistics. With competitive setup costs, flexible licensing options, and full foreign ownership in many sectors, Fujairah is ideal for startups, SMEs, and global investors. Businesses benefit from streamlined government support, modern infrastructure, and minimal trade restrictions. Its strategic position, growing economy, and business-friendly policies make Fujairah Mainland a strong choice for sustainable growth and regional expansion.
             </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: '#f8f9fa', padding: '56px 0 36px 0' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 32px' }}>
          ...
          <p style={{ textAlign: 'center', color: '#444', marginBottom: 36, fontFamily: 'Montserrat, Arial, sans-serif', fontWeight: 400, fontSize: 18 }}>
            Fujairah offers a strategic location and cost-effective solutions for business setup. Global Vision provides end-to-end support for your business journey in Fujairah.
          </p>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 32, alignItems: 'center', justifyContent: 'center' }}>
            <img src="/images/Fujairah Mainland.avif" alt="Fujairah Mainland Office" style={{ width: 340, height: 180, objectFit: 'cover', borderRadius: 18, flex: '1 1 340px', minWidth: 260, maxWidth: 380, boxShadow: '0 2px 12px rgba(30,198,182,0.07)', padding: 0, marginRight: 12 }} />
      ...
      {/* Why Fujairah Mainland is Perfect for Your Business Section */}
      <section style={{ background: '#fff', padding: '56px 0 36px 0' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 32px' }}>
          <h2 style={{ textAlign: 'center', fontWeight: 700, fontSize: '2rem', marginBottom: 8, fontFamily: 'Montserrat, Arial, sans-serif', color: '#222' }}>
            Why Fujairah Mainland is Perfect for Your Business
          </h2>
      ...
      {/* Steps to Setup Your Business in Fujairah Mainland Section */}
      <section style={{ background: '#f8f9fa', padding: '56px 0 36px 0' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 32px' }}>
          <h2 style={{ textAlign: 'center', fontWeight: 700, fontSize: '2rem', marginBottom: 8, fontFamily: 'Montserrat, Arial, sans-serif', color: '#222' }}>
            Steps to Setup Your Business in Fujairah Mainland
          </h2>
          <p style={{ textAlign: 'center', color: '#444', marginBottom: 40, fontFamily: 'Montserrat, Arial, sans-serif', fontWeight: 400, fontSize: 17 }}>
          ...
          <div style={{ marginBottom: 36 }}>
            ...
            <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
              ...
              <div style={{ border: '1.5px solid #1ec6b6', borderRadius: 12, padding: '22px 24px', minWidth: 220, flex: '1 1 220px', background: '#fff' }}>
                ...
                <div style={{ color: '#444', fontSize: 15, fontFamily: 'Montserrat, Arial, sans-serif' }}>Select and verify business activity with Fujairah DED</div>
              </div>
              {/* Legal Structure */}
              <div style={{ border: '1.5px solid #1ec6b6', borderRadius: 12, padding: '22px 24px', minWidth: 220, flex: '1 1 220px', background: '#fff' }}>
      ...
      <section style={{ background: '#f6f8f9', padding: '56px 0 36px 0' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 32px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
            ...
            {/* FAQ 5 */}
            <div style={{ background: '#fff', border: '1.5px solid #1ec6b6', borderRadius: 10, padding: '22px 28px' }}>
              <div style={{ fontWeight: 700, fontSize: 17, color: '#222', fontFamily: 'Montserrat, Arial, sans-serif', marginBottom: 6 }}>Can I operate outside Fujairah?</div>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', flexWrap: 'wrap', gap: 0, justifyContent: 'space-between', alignItems: 'flex-start', padding: '0 32px' }}>
          ...
          <div style={{ flex: '1 1 260px', minWidth: 220, marginBottom: 32 }}>
            ...
            <div style={{ color: '#bfc6d1', fontSize: '0.98rem', marginBottom: 12 }}>
              Your trusted partner for Fujairah mainland<br/>company formation and business setup<br/>services.
            </div>
          </div>
          {/* Services */}
