...
export default function UAQMainlandPage() {
  return (
    <>
      <Navbar />
        ...
        <div className="hero-content-wrapper" style={{ position: 'relative', zIndex: 2, display: 'flex', justifyContent: 'space-between', alignItems: 'center', maxWidth: 1200, margin: '0 auto', padding: '0 40px', minHeight: '100vh' }}>
          <div className="hero-content" style={{ flex: 1, color: '#fff', textAlign: 'left', paddingRight: 20, maxWidth: 600 }}>
            <h1 className="hero-title" style={{ fontFamily: 'Playfair Display, serif', fontSize: '3.2rem', fontWeight: 700, color: '#fff', lineHeight: 1.1, marginBottom: 18 }}>
              Business Setup in<br />UAQ Mainland
            </h1>
            <p className="hero-subtitle" style={{ fontFamily: 'Montserrat, Arial, sans-serif', fontSize: '1.25rem', color: '#d1d5db', marginBottom: 36, fontWeight: 400 }}>
              Your gateway to unlimited business opportunities in Umm Al Quwain with over a decade of expertise and 500+ successful launches.
            </p>
      ...
      <section style={{ background: '#f8f9fa', padding: '56px 0 36px 0' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 32px' }}>
          ...
          <p style={{ textAlign: 'center', color: '#444', marginBottom: 36, fontFamily: 'Montserrat, Arial, sans-serif', fontWeight: 400, fontSize: 18 }}>
            UAQ offers a strategic location and cost-effective solutions for business setup. Global Vision provides end-to-end support for your business journey in Umm Al Quwain.
          </p>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 32, alignItems: 'center', justifyContent: 'center' }}>
            <img src="/images/UAQ Mainland.avif" alt="UAQ Mainland Office" style={{ width: 340, height: 180, objectFit: 'cover', borderRadius: 18, flex: '1 1 340px', minWidth: 260, maxWidth: 380, boxShadow: '0 2px 12px rgba(30,198,182,0.07)', padding: 0, marginRight: 12 }} />
      ...
      {/* Why UAQ Mainland is Perfect for Your Business Section */}
      <section style={{ background: '#fff', padding: '56px 0 36px 0' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 32px' }}>
          <h2 style={{ textAlign: 'center', fontWeight: 700, fontSize: '2rem', marginBottom: 8, fontFamily: 'Montserrat, Arial, sans-serif', color: '#222' }}>
            Why UAQ Mainland is Perfect for Your Business
          </h2>
      ...
      {/* Steps to Setup Your Business in UAQ Mainland Section */}
      <section style={{ background: '#f8f9fa', padding: '56px 0 36px 0' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 32px' }}>
          <h2 style={{ textAlign: 'center', fontWeight: 700, fontSize: '2rem', marginBottom: 8, fontFamily: 'Montserrat, Arial, sans-serif', color: '#222' }}>
            Steps to Setup Your Business in UAQ Mainland
          </h2>
          <p style={{ textAlign: 'center', color: '#444', marginBottom: 40, fontFamily: 'Montserrat, Arial, sans-serif', fontWeight: 400, fontSize: 17 }}>
          ...
          <div style={{ marginBottom: 36 }}>
            ...
            <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
              ...
              <div style={{ border: '1.5px solid #1ec6b6', borderRadius: 12, padding: '22px 24px', minWidth: 220, flex: '1 1 220px', background: '#fff' }}>
                ...
                <div style={{ color: '#444', fontSize: 15, fontFamily: 'Montserrat, Arial, sans-serif' }}>Select and verify business activity with UAQ DED</div>
              </div>
              {/* Legal Structure */}
              <div style={{ border: '1.5px solid #1ec6b6', borderRadius: 12, padding: '22px 24px', minWidth: 220, flex: '1 1 220px', background: '#fff' }}>
      ...
      <section style={{ background: '#fdf7f3', padding: '56px 0 36px 0' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 32px' }}>
          ...
          <div className="packages-row" style={{ display: 'flex', flexDirection: 'row', gap: 32, justifyContent: 'center', alignItems: 'stretch', flexWrap: 'nowrap' }}>
            ...
            {/* UAQ Mainland License */}
            <div style={{ background: '#fff', border: '2px solid #1ec6b6', borderRadius: 18, padding: '36px 32px', minWidth: 260, maxWidth: 320, flex: '1 1 300px', textAlign: 'center', boxShadow: '0 2px 8px rgba(30,198,182,0.04)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              <div>
                <div style={{ fontWeight: 700, fontSize: 18, marginBottom: 18, color: '#222', fontFamily: 'Montserrat, Arial, sans-serif' }}>UAQ Mainland License</div>
            ...
            {/* UAQ Freezone License */}
            <div style={{ background: '#fff', border: '2px solid #1ec6b6', borderRadius: 18, padding: '36px 32px', minWidth: 260, maxWidth: 320, flex: '1 1 300px', textAlign: 'center', boxShadow: '0 2px 8px rgba(30,198,182,0.04)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              <div>
                <div style={{ fontWeight: 700, fontSize: 18, marginBottom: 18, color: '#222', fontFamily: 'Montserrat, Arial, sans-serif' }}>UAQ Freezone License</div>
          ...
          <div style={{ display: 'flex', gap: 28, flexWrap: 'nowrap', justifyContent: 'center', alignItems: 'stretch' }}>
            ...
            <div style={{ background: '#fff', border: '1.5px solid #1ec6b6', borderRadius: 14, padding: '28px 24px', minWidth: 260, maxWidth: 340, flex: '1 1 300px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              ...
              <div style={{ color: '#444', fontSize: 15, fontFamily: 'Montserrat, Arial, sans-serif', fontStyle: 'italic' }}>
                "Global Vision accelerated our UAQ license and gave us the market presence we needed."
              </div>
            </div>
            {/* Testimonial 2 */}
            <div style={{ background: '#fff', border: '1.5px solid #1ec6b6', borderRadius: 14, padding: '28px 24px', minWidth: 260, maxWidth: 340, flex: '1 1 300px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            ...
            <div style={{ background: '#fff', border: '1.5px solid #1ec6b6', borderRadius: 14, padding: '28px 24px', minWidth: 260, maxWidth: 340, flex: '1 1 300px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              ...
              <div style={{ color: '#444', fontSize: 15, fontFamily: 'Montserrat, Arial, sans-serif', fontStyle: 'italic' }}>
                "We appreciated the legal insights that helped us meet UAQ requirements."
              </div>
            </div>
          </div>
        </div>
      ...
      <section style={{ background: '#f6f8f9', padding: '56px 0 36px 0' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 32px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
            ...
            {/* FAQ 5 */}
            <div style={{ background: '#fff', border: '1.5px solid #1ec6b6', borderRadius: 10, padding: '22px 28px' }}>
              <div style={{ fontWeight: 700, fontSize: 17, color: '#222', fontFamily: 'Montserrat, Arial, sans-serif', marginBottom: 6 }}>Can I operate outside UAQ?</div>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', flexWrap: 'wrap', gap: 0, justifyContent: 'space-between', alignItems: 'flex-start', padding: '0 32px' }}>
          ...
          <div style={{ flex: '1 1 260px', minWidth: 220, marginBottom: 32 }}>
            ...
            <div style={{ color: '#bfc6d1', fontSize: '0.98rem', marginBottom: 12 }}>
              Your trusted partner for UAQ mainland<br/>company formation and business setup<br/>services.
            </div>
          </div>
          {/* Services */}
