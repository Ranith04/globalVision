        ...
        <div className="hero-content-wrapper" style={{ position: 'relative', zIndex: 2, display: 'flex', justifyContent: 'space-between', alignItems: 'center', maxWidth: 1200, margin: '0 auto', padding: '0 40px', minHeight: '100vh' }}>
          <div className="hero-content" style={{ flex: 1, color: '#fff', textAlign: 'left', paddingRight: 20, maxWidth: 600 }}>
            <h1 className="hero-title" style={{ fontFamily: 'Playfair Display, serif', fontSize: '3.2rem', fontWeight: 700, color: '#fff', lineHeight: 1.1, marginBottom: 18 }}>
              Business Setup in<br />Dubai Mainland
            </h1>
            <p className="hero-subtitle" style={{ fontFamily: 'Montserrat, Arial, sans-serif', fontSize: '1.25rem', color: '#d1d5db', marginBottom: 36, fontWeight: 400 }}>
              Your gateway to unlimited business opportunities in the UAE with over a decade of expertise and 500+ successful launches.
            </p>
      ...
      <section style={{ background: '#f8f9fa', padding: '56px 0 36px 0' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 32px' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 32, alignItems: 'center', justifyContent: 'center' }}>
            <img src="/images/dubai-m1.jpg" alt="Dubai Office" style={{ width: 340, height: 180, objectFit: 'cover', borderRadius: 18, flex: '1 1 340px', minWidth: 260, maxWidth: 380, boxShadow: '0 2px 12px rgba(30,198,182,0.07)', padding: 0, marginRight: 12 }} />
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 32px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: 48, marginBottom: 36, flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: '1 1 220px', minWidth: 200, maxWidth: 300, textAlign: 'center' }}>
              ...
              <div style={{ fontWeight: 700, fontSize: '1.1rem', marginBottom: 4, fontFamily: 'Montserrat, Arial, sans-serif', color: '#222' }}>Government Tenders</div>
              <div style={{ color: '#444', fontSize: 15, marginBottom: 0, fontFamily: 'Montserrat, Arial, sans-serif' }}>
          ...
          <div style={{ display: 'flex', gap: 32, flexWrap: 'wrap', justifyContent: 'center' }}>
            ...
            <div style={{ background: '#fafbfc', borderRadius: 14, boxShadow: '0 2px 8px rgba(30,198,182,0.04)', padding: '28px 32px', minWidth: 260, maxWidth: 380, flex: '1 1 320px' }}>
              <div style={{ fontWeight: 700, fontSize: 17, marginBottom: 12, color: '#222', fontFamily: 'Montserrat, Arial, sans-serif' }}>Financial Freedom</div>
              <ul style={{ color: '#1ec6b6', fontSize: 15, fontFamily: 'Montserrat, Arial, sans-serif', paddingLeft: 20, margin: 0, listStyle: 'none' }}>
                <li style={{ marginBottom: 8 }}><span style={{ color: '#1ec6b6', marginRight: 6 }}>✓</span>No currency restrictions</li>
                <li style={{ marginBottom: 8 }}><span style={{ color: '#1ec6b6', marginRight: 6 }}>✓</span>Freedom to repatriate profits</li>
                <li><span style={{ color: '#1ec6b6', marginRight: 6 }}>✓</span>9% corporate tax on profits above AED 375,000</li>
              </ul>
            </div>
            {/* Strategic Benefits */}
            <div style={{ background: '#fafbfc', borderRadius: 14, boxShadow: '0 2px 8px rgba(30,198,182,0.04)', padding: '28px 32px', minWidth: 260, maxWidth: 380, flex: '1 1 320px' }}>
              <div style={{ fontWeight: 700, fontSize: 17, marginBottom: 12, color: '#222', fontFamily: 'Montserrat, Arial, sans-serif' }}>Strategic Benefits</div>
              <ul style={{ color: '#1ec6b6', fontSize: 15, fontFamily: 'Montserrat, Arial, sans-serif', paddingLeft: 20, margin: 0, listStyle: 'none' }}>
                <li style={{ marginBottom: 8 }}><span style={{ color: '#1ec6b6', marginRight: 6 }}>✓</span>Unlimited visas (1 per 80 sq. ft.)</li>
                <li style={{ marginBottom: 8 }}><span style={{ color: '#1ec6b6', marginRight: 6 }}>✓</span>Global brand credibility</li>
                <li><span style={{ color: '#1ec6b6', marginRight: 6 }}>✓</span>Strategic geographic location</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div style={{ marginBottom: 36 }}>
            ...
            <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
              ...
              <div style={{ border: '1.5px solid #1ec6b6', borderRadius: 12, padding: '22px 24px', minWidth: 220, flex: '1 1 220px', background: '#fff' }}>
                ...
                <div style={{ color: '#444', fontSize: 15, fontFamily: 'Montserrat, Arial, sans-serif' }}>Select and verify business activity with DED</div>
              </div>
              {/* Legal Structure */}
              <div style={{ border: '1.5px solid #1ec6b6', borderRadius: 12, padding: '22px 24px', minWidth: 220, flex: '1 1 220px', background: '#fff' }}>
          ...
          <div style={{ marginBottom: 36 }}>
            ...
            <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
              ...
              <div style={{ background: '#fff', borderRadius: 12, padding: '22px 24px', minWidth: 180, flex: '1 1 180px', textAlign: 'center', border: '1px solid #e5e7eb' }}>
                ...
                <div style={{ fontWeight: 700, fontSize: 15, color: '#222', fontFamily: 'Montserrat, Arial, sans-serif' }}>Ejari Lease</div>
              </div>
              {/* Trade License */}
              <div style={{ background: '#fff', borderRadius: 12, padding: '22px 24px', minWidth: 180, flex: '1 1 180px', textAlign: 'center', border: '1px solid #e5e7eb' }}>
                <div style={{ fontSize: 28, marginBottom: 6 }}>
          ...
          <div className="packages-row" style={{ display: 'flex', flexDirection: 'row', gap: 32, justifyContent: 'center', alignItems: 'stretch', flexWrap: 'nowrap' }}>
            ...
            <div style={{ background: '#fff', border: '2px solid #1ec6b6', borderRadius: 18, padding: '36px 32px', minWidth: 260, maxWidth: 320, flex: '1 1 300px', textAlign: 'center', boxShadow: '0 2px 8px rgba(30,198,182,0.04)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              <div>
                ...
                <div style={{ background: '#1ec6b6', color: '#fff', borderRadius: 22, display: 'inline-block', padding: '6px 28px', fontWeight: 700, fontSize: 22, marginBottom: 18, fontFamily: 'Montserrat, Arial, sans-serif' }}>AED 5,499</div>
            ...
            <div style={{ background: '#fff', border: '2px solid #1ec6b6', borderRadius: 18, padding: '36px 32px', minWidth: 260, maxWidth: 320, flex: '1 1 300px', textAlign: 'center', boxShadow: '0 2px 8px rgba(30,198,182,0.04)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              <div>
                <div style={{ fontWeight: 700, fontSize: 18, marginBottom: 18, color: '#222', fontFamily: 'Montserrat, Arial, sans-serif' }}>Dubai Freezone License</div>
                <div style={{ background: '#1ec6b6', color: '#fff', borderRadius: 22, display: 'inline-block', padding: '6px 28px', fontWeight: 700, fontSize: 22, marginBottom: 18, fontFamily: 'Montserrat, Arial, sans-serif' }}>AED 12,500</div>
                <ul style={{ color: '#444', fontSize: 15, fontFamily: 'Montserrat, Arial, sans-serif', paddingLeft: 0, margin: '18px 0 28px 0', listStyle: 'none', textAlign: 'left' }}>
            ...
            <div style={{ background: '#fff', border: '2px solid #1ec6b6', borderRadius: 18, padding: '36px 32px', minWidth: 260, maxWidth: 320, flex: '1 1 300px', textAlign: 'center', boxShadow: '0 2px 8px rgba(30,198,182,0.04)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              <div>
                <div style={{ fontWeight: 700, fontSize: 18, marginBottom: 18, color: '#222', fontFamily: 'Montserrat, Arial, sans-serif' }}>Dubai Mainland License</div>
                <div style={{ background: '#1ec6b6', color: '#fff', borderRadius: 22, display: 'inline-block', padding: '6px 28px', fontWeight: 700, fontSize: 22, marginBottom: 18, fontFamily: 'Montserrat, Arial, sans-serif' }}>AED 14,999</div>
                <ul style={{ color: '#444', fontSize: 15, fontFamily: 'Montserrat, Arial, sans-serif', paddingLeft: 0, margin: '18px 0 28px 0', listStyle: 'none', textAlign: 'left' }}>
      ...
      <section style={{ background: '#f6f8f9', padding: '56px 0 36px 0' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 32px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
            ...
            {/* FAQ 5 */}
            <div style={{ background: '#fff', border: '1.5px solid #1ec6b6', borderRadius: 10, padding: '22px 28px' }}>
              <div style={{ fontWeight: 700, fontSize: 17, color: '#222', fontFamily: 'Montserrat, Arial, sans-serif', marginBottom: 6 }}>Can I operate outside Dubai?</div>
