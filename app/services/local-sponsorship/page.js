  ...
  return (
    <>
      ...
      <FreezoneHeroWithForm
        title={"Local Sponsorship in UAE"}
        description={"Trusted local sponsor services for mainland company formation. 100% operational control, transparent agreements, and reliable support."}
        ctaText="Get Local Sponsor"
      ...
      <section style={{ background: '#E0E3EA', padding: '60px 0' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', alignItems: 'center', gap: 48, padding: '0 32px' }}>
          ...
          <div style={{ flex: 1, minWidth: 500, maxWidth: 500, padding: '12px' }}>
            <img src="/images/UAE Sponsorship Process.png" alt="Dubai Skyline" style={{ borderRadius: 16, width: '100%', height: 'auto' }} />
          </div>
        </div>
      </section>
      ...
      <section style={{ background: '#f8fafc', padding: '90px 0 110px 0', textAlign: 'center' }}>
        ...
        <div style={{
          ...
          <div style={{ background: '#fff', borderRadius: 22, boxShadow: '0 4px 18px rgba(30,198,182,0.10)', padding: '54px 38px', textAlign: 'center', minWidth: 0, maxWidth: 400, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      <section style={{ background: '#fff', padding: '64px 0 0 0', display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'center', gap: 48, maxWidth: 1200, margin: '0 auto' }}>
        {/* Left: Steps */}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 22 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 18 }}>
              ...
              <div>
                ...
                <div style={{ color: '#4a5a6a', fontSize: 15 }}>We help gather and prepare all required documents according to UAE regulations.</div>
              </div>
            </div>
            {/* Step 2 */}
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 18 }}>
              ...
              <div>
                ...
                <div style={{ color: '#4a5a6a', fontSize: 15 }}>Submit applications to relevant authorities with proper documentation.</div>
              </div>
            </div>
            {/* Step 3 */}
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 18 }}>
              ...
              <div>
                <div style={{ fontWeight: 700, color: '#222', fontSize: 16 }}>Processing & Follow-up</div>
                <div style={{ color: '#4a5a6a', fontSize: 15 }}>Track application progress and handle any additional requirements.</div>
              </div>
            </div>
            {/* Step 4 */}
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 18 }}>
              ...
              <div>
                <div style={{ fontWeight: 700, color: '#222', fontSize: 16 }}>Approval & Completion</div>
                <div style={{ color: '#4a5a6a', fontSize: 15 }}>Receive approvals and complete final procedures for sponsorship.</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={{ flex: '1 1 340px', minWidth: 260, maxWidth: 420, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0 24px' }}>
          ...
          <img src="/images/UAE Sponsorship Process.png" alt="Sponsorship Process" style={{ width: '100%', maxWidth: 480, height: 280, objectFit: 'cover', borderRadius: 14, boxShadow: '0 2px 12px rgba(30,198,182,0.10)' }} />
        </div>
      </section>

      {/* Section 5: Why Choose Our Sponsorship Services? */}
      <section style={{ background: '#f8fafc', padding: '64px 0 80px 0', textAlign: 'center' }}>
      ...
      <section style={{ background: '#fff', padding: '60px 0 32px 0', textAlign: 'center' }}>
