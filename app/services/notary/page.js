  ...
  return (
    <>
      ...
      <FreezoneHeroWithForm
        ...
        description={"Official notary public services for document attestation, certification, and legalization in Dubai and across the UAE."}
        ctaText="Get Notary Services"
...
<section style={{ background: '#E0E3EA', padding: '60px 0' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', alignItems: 'center', gap: 48, padding: '0 32px' }}>
          ...
          <div style={{ flex: 1, minWidth: 500, maxWidth: 500, padding: '12px' }}>
            <img src="/images/Background+Border+Shadow (1).png" alt="Dubai Skyline" style={{ borderRadius: 16, width: '100%', height: 'auto' }} />
          </div>
        </div>
      </section>
      ...
      <section style={{ background: '#fff', padding: '64px 0 64px 0', display: 'flex', justifyContent: 'center', alignItems: 'flex-start', gap: 48, maxWidth: 1600, margin: '0 auto 32px auto' }}>
        {/* Left Column */}
        <div style={{ flex: 1.2, minWidth: 0, maxWidth: 800, textAlign: 'left', padding: '0 32px' }}>
          ...
          <button style={{ background: 'linear-gradient(90deg, #19b893 60%, #00796b 100%)', color: '#fff', border: 'none', borderRadius: 8, padding: '15px 38px', fontWeight: 700, fontSize: 18, cursor: 'pointer', marginTop: 0, display: 'flex', alignItems: 'center', gap: 10, boxShadow: '0 2px 8px rgba(30,198,182,0.10)' }}>
        ...
        <div style={{ flex: 1, minWidth: 0, maxWidth: 600, display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: 24 }}>
          <img src="/images/Notary Services Dubai.png" alt="Notary Document Signing" style={{ width: '100%', borderRadius: 22, objectFit: 'cover', maxHeight: 370, boxShadow: '0 2px 16px rgba(30,198,182,0.08)', marginTop: '100px', marginLeft: '-15not demo 0px' }} />
        </div>
      </section>
