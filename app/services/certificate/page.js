...
export default function CertificatePage() {
  return (
    <>
      ...
      <div style={{ background: '#fff', padding: '64px 0 0 0', textAlign: 'center' }}>
        ...
        <div style={{
          ...
          <div style={{ background: '#fff', borderRadius: 22, boxShadow: '0 2px 12px rgba(30,198,182,0.07)', padding: '36px 28px', textAlign: 'left', minWidth: 0, maxWidth: 370, border: '1.5px solid #f0f3f7', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
            ...
            <button style={{ background: '#fff', color: '#222', border: '1.5px solid #e3f6f4', borderRadius: 8, padding: '10px 28px', fontWeight: 600, fontSize: 15, cursor: 'pointer', marginTop: 'auto', display: 'flex', alignItems: 'center', gap: 8 }}>
      ...
      <section style={{ background: '#fafbfc', padding: '56px 0 56px 0', textAlign: 'center' }}>
      ...
      <section style={{ background: '#fff', padding: '64px 0 64px 0', display: 'flex', justifyContent: 'center', alignItems: 'flex-start', gap: 48, maxWidth: 1400, margin: '0 auto' }}>
        {/* Left Column */}
        ...
        <div style={{ flex: 1, minWidth: 0, maxWidth: 520, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <img src="/images/Certificate Attestation Dubai.png" alt="Certificate Attestation" style={{ width: '100%', borderRadius: 22, objectFit: 'cover', maxHeight: 320, boxShadow: '0 2px 16px rgba(30,198,182,0.08)', marginTop: '200px' }} />
        </div>
      </section>
       {/* Global Attestation Services Section */}
       <section style={{ background: '#fafbfc', padding: '64px 0 64px 0', textAlign: 'center' }}>
        <h2 style={{ fontWeight: 700, fontSize: '2.2rem', color: '#222', marginBottom: 14, fontFamily: 'Playfair Display, serif' }}>
        ...
        <button style={{ background: '#fff', color: '#222', border: '1.5px solid #e3f6f4', borderRadius: 8, padding: '12px 32px', fontWeight: 600, fontSize: 16, cursor: 'pointer', marginTop: 0, display: 'inline-flex', alignItems: 'center', gap: 10, boxShadow: '0 2px 8px rgba(30,198,182,0.10)' }}>
          View All Countries <span style={{ fontSize: 20, marginLeft: 2 }}>🌐</span>
        </button>
      </section>

      {/* Why Choose Our Attestation Services Section */}
      <section style={{ background: '#fff', padding: '56px 0 56px 0', textAlign: 'center' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px' }}>
          <h2 style={{ fontWeight: 700, fontSize: '2.2rem', color: '#222', marginBottom: 14, fontFamily: 'Playfair Display, serif' }}>
          ...
          <div style={{
            ...
            <div style={{ background: '#fff', borderRadius: 22, boxShadow: '0 2px 12px rgba(30,198,182,0.07)', padding: '36px 24px', textAlign: 'center', minWidth: 0, border: '1.5px solid #e8f1f7', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <div style={{ color: '#6b7683', fontSize: 15, marginBottom: 18 }}>Quick turnaround times with express services available</div>
            ...
            <div style={{ background: '#fff', borderRadius: 22, boxShadow: '0 2px 12px rgba(30,198,182,0.07)', padding: '36px 24px', textAlign: 'center', minWidth: 0, border: '1.5px solid #e8f1f7', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <div style={{ fontWeight: 700, color: '#222', fontSize: 16, marginBottom: 4 }}>Secure Handling</div>
              <div style={{ color: '#6b7683', fontSize: 15, marginBottom: 18 }}>Safe and secure handling of your valuable documents</div>
              <div style={{ background: '#f6fafd', color: '#222', fontWeight: 600, fontSize: 15, borderRadius: 12, padding: '7px 18px', marginTop: 'auto', minWidth: 0, display: 'inline-block', border: '1.2px solid #e3f6f4' }}>
                100% Secure
              </div>
            </div>
            ...
            <div style={{ background: '#fff', borderRadius: 22, boxShadow: '0 2px 12px rgba(30,198,182,0.07)', padding: '36px 24px', textAlign: 'center', minWidth: 0, border: '1.5px solid #e8f1f7', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <div style={{ color: '#6b7683', fontSize: 15, marginBottom: 18 }}>Experienced professionals with deep knowledge of attestation procedures</div>
              <div style={{ background: '#f6fafd', color: '#222', fontWeight: 600, fontSize: 15, borderRadius: 12, padding: '7px 18px', marginTop: 'auto', minWidth: 0, display: 'inline-block', border: '1.2px solid #e3f6f4' }}>
                10+ Years Experience
              </div>
            </div>
            ...
            <div style={{ background: '#fff', borderRadius: 22, boxShadow: '0 2px 12px rgba(30,198,182,0.07)', padding: '36px 24px', textAlign: 'center', minWidth: 0, border: '1.5px solid #e8f1f7', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <div style={{ fontWeight: 700, color: '#222', fontSize: 16, marginBottom: 4 }}>Success Rate</div>
              <div style={{ color: '#6b7683', fontSize: 15, marginBottom: 18 }}>High success rate with proper documentation and follow-up</div>
              <div style={{ background: '#f6fafd', color: '#222', fontWeight: 600, fontSize: 15, borderRadius: 12, padding: '7px 18px', marginTop: 'auto', minWidth: 0, display: 'inline-block', border: '1.2px solid #e3f6f4' }}>
                99% Success
              </div>
            </div>
 ...
 <section style={{ background: '#fff', padding: '64px 0 0 0', textAlign: 'center' }}>
        <h2 style={{ fontWeight: 700, fontSize: '2.2rem', color: '#222', marginBottom: 14, fontFamily: 'Playfair Display, serif' }}>
