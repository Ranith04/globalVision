  ...
  return (
    <div style={{ background: '#f7f7f7' }}>
      ...
      <section style={{  background: '#E0E3EA', padding: '48px 0' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', alignItems: 'center', gap: 48, padding: '0 24px' }}>
          <div style={{ flex: 1 }}>
      ...
      <section style={{ background: '#fff', padding: '32px 0 0 0' }}>
      ...
      <section style={{ background: '#fff', padding: '0 0 48px 0' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px' }}>
          ...
          <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1, minWidth: 320, background: '#f7f7f7', borderRadius: 14, padding: 24, boxShadow: '0 2px 8px rgba(30,198,182,0.06)', border: '1.5px solid #e0e0e0' }}>
              ...
              <ul style={{ color: '#222', fontSize: '1rem', marginBottom: 10, paddingLeft: 20 }}>
                ...
                <li>Minimum UAE 20,000+ salary (recommended)</li>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 18, marginBottom: 16 }}>
            ...
            <div style={{ display: 'flex', gap: 16, justifyContent: 'center' }}>
              <div style={{ background: '#fff', borderRadius: 12, padding: '12px 16px', boxShadow: '0 1px 4px rgba(30,198,182,0.04)', border: '1px solid #f0f0f0', minWidth: 180, minHeight: 70, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center' }}>
            <a href="#" style={{ background: '#1ec6b6', color: '#fff', padding: '10px 28px', borderRadius: 30, fontWeight: 600, fontSize: '1rem', textDecoration: 'none', display: 'inline-block', margin: '0 auto' }}>View All Banking Partners</a>
          </div>
        </div>
      </section>
      ...
      <footer style={{ background: '#151b26', color: '#e5e7eb', padding: '56px 0 0 0', fontSize: '1rem' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', flexWrap: 'wrap', gap: 0, justifyContent: 'space-between', alignItems: 'flex-start', padding: '0 24px' }}>
          {/* Logo & Description */}
        ...
        <div style={{ maxWidth: 1100, margin: '32px auto 0 auto', borderTop: '1px solid #232b39', padding: '18px 24px 18px 24px', display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', color: '#bfc6d1', fontSize: '0.98rem' }}>
