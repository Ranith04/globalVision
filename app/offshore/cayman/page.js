  ...
  return (
    <>
      ...
      <FreezoneHeroWithForm
        title={"Cayman Islands Offshore Company"}
        description={"Incorporate in the Cayman Islands for tax neutrality, privacy, and global credibility. Ideal for investment funds, holding companies, and international business."}
        ctaText="Start Cayman Company"
